    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_path', models.ImageField(blank=True, null=True, upload_to='students/media/photos/')),
                ('payment_proof', models.FileField(blank=True, null=True, upload_to='students/media/payments/')),
